...
!  Indexing goes row, column in Fortran 

!====================================================================

implicit none

integer, parameter :: n=6, bSz = 160000

double precision :: a(n,n),b(n),bhold(n),Ahold(n,n),As(n,n),d

double precision :: timet,time, ti, tf

integer i,j, indx(n), code

! matrix A

data (a(1,i), i=1,6) / 0.8147,    0.2785,    0.9572 ,   0.7922   , 0.6787  ,  0.7060/

data (a(2,i), i=1,6) /  0.9058,    0.5469 ,   0.4854 ,   0.9595 ,   0.7577  ,  0.0318 /

data (a(3,i), i=1,6) /  0.1270 ,   0.9575  ,  0.8003  ,  0.6557  ,  0.7431  ,  0.2769 /

data (a(4,i), i=1,6) / 0.9134  ,  0.9649  ,  0.1419  , 0.0357  ,  0.3922   , 0.0462 /

data (a(5,i), i=1,6) /  0.6324 ,   0.1576   , 0.4218 ,   0.8491   , 0.6555  ,  0.0971 /

data (a(6,i), i=1,6) /  0.0975 ,   0.9706  ,  0.9157  ,  0.9340   , 0.1712   , 0.8235 /


data (b(i), i=1,6) / 0.8143,    0.2435,    0.9293,    0.3500,    0.1966,    0.2511 /
