MODULE CPSOLV
 ...
 !$omp end parallel
   ...
   !!START OF SOLUTION PROCEDURE
    ...
    ELSE
 	!$OMP PARALLEL DEFAULT(PRIVATE) &
    !$omp shared(NSLIP,NC,IFLAG,SSYSMAT,STRESS2BE,DG2,DGDO,EXPN,DMAX,SLPRESA2,IITR,DELTPK,TPKOLD,EROR,EYE,STRV,C6A,C6P6A,TJINV,ICORR)  
    !$omp do 
...
!$omp end parallel
	...
	!endif
 	...
 	!$OMP PARALLEL DEFAULT(PRIVATE) &
    !$omp shared(SO,SS,EXPA,KUPD,IFLAG,IITR,DELTPK,STRESS2BE,SSYSMAT,DG2,SLPRESA2,DGDO,EXPN,SLPRA1,SLPRA2,STRS1PK)  
    !$omp do 
