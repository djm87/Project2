    ...
    PROGRAM POLYPL
     ...
     ! call cpu_time(toti)
      ...
      FILENAME1 = '/home/administrator/Documents/DAN/itter_spectral_comp/Parent_OMP_C/timing.txt'
      FILENAME = 'stress.txt'
      ...
      CALL POLYPLMDL(FILENAME,FILENAME1,FILENAME2,IPOINT,NSTEP,IDEF, &
      ...
      SUBROUTINE POLYPLMDL(FILENAME,FILENAME1,FILENAME2,IPOINT,NSTEP,IDEF, &
                       DT,TEPS,DEFGRDXX,DEFGRDXY,DEFGRDXZ, &
                       DEFGRDYX,DEFGRDYY,DEFGRDYZ,DEFGRDZX, &
                       DEFGRDZY,DEFGRDZZ,PHI1,PHI,PHI2,NC)
      USE Variables
