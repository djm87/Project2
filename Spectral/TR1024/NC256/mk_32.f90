module SCP_VARIABLES
  ...
  integer, parameter :: SUP_IND = 1024, NCRYS = 256, m_fine = 3000 !change, added m_fine
...
!
 ...
 close (56)
  ...
  OPEN(unit=14, file='/home/administrator/Documents/DAN/itter_spectral_comp/Spectral/timing_TR1024.txt',STATUS='replace')
