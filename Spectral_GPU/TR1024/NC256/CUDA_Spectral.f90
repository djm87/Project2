...
!print *,"D_eig",D_eig
  ...
  WRITE(*,'(7F11.5)')  REAL(i,KIND=RP)*1.0_rp/REAL(n_steps,KIND=RP),STRESS_VEC(n_steps,:)
  DO I = 1,n_steps
  ...
  OPEN(unit=14, file='/home/administrator/Documents/DAN/itter_spectral_comp/Spectral_GPU/timing_TR1024.txt',STATUS='replace')
  write(14,'(i6,1F11.5)') NCRYS, (SUM(cpu_t)*1.e3_rp + SUM(cuda_t))*1.e-3_rp
  CLOSE(14)
